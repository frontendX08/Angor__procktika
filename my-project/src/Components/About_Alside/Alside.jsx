    ...
    <div className="flex flex-col items-center w-full relative gap-12 px-8 py-20 lg:px-28">
        ...
        <div className="flex flex-col w-full gap-5 max-w-7xl">
            {reviews.map((review, index) => (
                <div key={index} className="flex flex-col gap-2 p-3 bg-[#161d29] rounded-md">
                    <div className="flex items-center gap-3">
                        <div className={`w-9 h-9 rounded-full bg-cover bg-center`} style={{ backgroundImage: `url('${review.image}')` }} />
